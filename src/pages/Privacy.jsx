...
export default function Privacy() {
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <div>
        <h2 className="text-base font-semibold text-slate-900">What the published notice will need to cover</h2>
        <p className="mt-2">
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5">
          <li>
            <strong className="font-medium text-slate-800">What is collected.</strong> Names and email addresses
          ...
          <li>
            <strong className="font-medium text-slate-800">Why, and on what lawful basis.</strong> Typically
          ...
          <li>
            <strong className="font-medium text-slate-800">Who it is shared with.</strong> Sub-processors used to
            run the service, including hosting, database and email providers, and the countries they operate in.
          </li>
          <li>
            <strong className="font-medium text-slate-800">How long it is kept.</strong> Evidence of a completed
          ...
          <li>
            <strong className="font-medium text-slate-800">Individual rights.</strong> Access, rectification,
          ...
          <li>
            <strong className="font-medium text-slate-800">Complaints.</strong> The right to complain to the
      ...
      <div>
        <h2 className="text-base font-semibold text-slate-900">Also needed for business customers</h2>
        <p className="mt-2">
